...
final getFixturesUseCaseProvider = Provider<GetFixtures>(
  (ref) => GetFixtures(ref.watch(fixturesRepositoryProvider)),
);
final getFixtureByIdUseCaseProvider = Provider<GetFixtureById>(
  (ref) => GetFixtureById(ref.watch(fixturesRepositoryProvider)),
);
...
final getLiveScoresUseCaseProvider = Provider<GetLiveScores>(
  (ref) => GetLiveScores(ref.watch(liveScoreRepositoryProvider)),
);
final getMatchEventsUseCaseProvider = Provider<GetMatchEvents>(
  (ref) => GetMatchEvents(ref.watch(liveScoreRepositoryProvider)),
);

final getTeamsUseCaseProvider = Provider<GetTeams>(
  (ref) => GetTeams(ref.watch(teamsRepositoryProvider)),
);
...
final getGroupStandingsUseCaseProvider = Provider<GetGroupStandings>(
  (ref) => GetGroupStandings(ref.watch(groupsRepositoryProvider)),
);
final sortGroupStandingsUseCaseProvider = Provider<SortGroupStandings>(
  (ref) => const SortGroupStandings(),
);

final getHomeSummaryUseCaseProvider = Provider<GetHomeSummary>(
  (ref) => GetHomeSummary(ref.watch(homeRepositoryProvider)),
);

final getNewsUseCaseProvider = Provider<GetNews>(
  (ref) => GetNews(ref.watch(newsRepositoryProvider)),
);
final searchNewsUseCaseProvider = Provider<SearchNews>(
  (ref) => SearchNews(ref.watch(newsRepositoryProvider)),
);
final sortNewsByPublishedDateUseCaseProvider =
    Provider<SortNewsByPublishedDate>((ref) => const SortNewsByPublishedDate());

final getFavoritesUseCaseProvider = Provider<GetFavorites>(
  (ref) => GetFavorites(ref.watch(favoritesRepositoryProvider)),
);
final addFavoriteUseCaseProvider = Provider<AddFavorite>(
  (ref) => AddFavorite(ref.watch(favoritesRepositoryProvider)),
);
final removeFavoriteUseCaseProvider = Provider<RemoveFavorite>(
...
final calculateCountdownUseCaseProvider = Provider<CalculateCountdown>(
  (ref) => const CalculateCountdown(),
);
final getTournamentCountdownUseCaseProvider = Provider<GetTournamentCountdown>((
  ref,
) {
  return GetTournamentCountdown(
    repository: ref.watch(countdownRepositoryProvider),
  );
});
