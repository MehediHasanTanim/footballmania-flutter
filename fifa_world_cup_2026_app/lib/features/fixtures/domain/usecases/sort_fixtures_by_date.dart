...
class SortFixturesByDate {
  ...
  List<Fixture> call(
    ...
    sorted.sort((a, b) {
      ...
      if (completedLast && a.isCompleted != b.isCompleted) return a.isCompleted ? 1 : -1;
      return _dateValue(a).compareTo(_dateValue(b));
    });
    return List.unmodifiable(sorted);
  }

  DateTime _dateValue(Fixture fixture) => fixture.matchDateUtc ?? DateTime.fromMillisecondsSinceEpoch(0, isUtc: true);
}
