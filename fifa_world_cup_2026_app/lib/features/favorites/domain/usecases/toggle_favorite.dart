...
class ToggleFavorite {
  ...
  Future<Result<bool>> call(FavoriteItem favorite) async {
    final existing = await _repository.isFavorite(
      type: favorite.type,
    ...
    if (isFavorite) {
      final removed = await _repository.removeFavorite(
        type: favorite.type,
        referenceId: favorite.referenceId,
      );
    ...
    if (added is FailureResult<FavoriteItem>) {
      return FailureResult(added.failure);
    }
