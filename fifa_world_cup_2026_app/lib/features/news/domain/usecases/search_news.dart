...
class SearchNews {
  ...
  Future<Result<List<News>>> call({required String query, int page = 1, int pageSize = 20, bool forceRefresh = false}) {
    return _repository.searchNews(query: query, page: page, pageSize: pageSize, forceRefresh: forceRefresh);
  }
