...
class NewsLocalDataSource {
  ...
  Future<void> cacheNews(List<NewsDto> news) async {
    ...
    await _cacheService.putAll<CachedNews>(
      HiveConstants.newsBox,
  ...
  List<NewsDto> searchNews({required String query, int page = 1, int pageSize = 20}) {
    ...
    final items = _cacheService
        ...
        .where((news) =>
            ...
            news.description?.toLowerCase().contains(normalizedQuery) == true ||
