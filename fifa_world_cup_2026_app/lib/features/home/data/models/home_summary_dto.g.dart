...
_$HomeSummaryDtoImpl _$$HomeSummaryDtoImplFromJson(Map<String, dynamic> json) =>
    _$HomeSummaryDtoImpl(
      countdownTargetDate:
          const DateTimeJsonConverter().fromJson(json['countdown_target_date']),
      nextMatch: json['next_match'] == null
          ? null
          : FixtureDto.fromJson(json['next_match'] as Map<String, dynamic>),
      liveMatches: (json['live_matches'] as List<dynamic>?)
      ...
      latestNews: (json['latest_news'] as List<dynamic>?)
              ...
              .toList() ??
          const <NewsDto>[],
      groupHighlights: (json['group_highlights'] as List<dynamic>?)
...
Map<String, dynamic> _$$HomeSummaryDtoImplToJson(
    ...
    <String, dynamic>{
      'countdown_target_date':
          const DateTimeJsonConverter().toJson(instance.countdownTargetDate),
